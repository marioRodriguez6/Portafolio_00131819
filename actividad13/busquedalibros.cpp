...
int main(){
    ...
    do{
        ...
        cout << "Menu: \n\t1) Agregar Libro\n\t2) Ver Libros"
        << "\n\t3) Eliminar libro\n\t4) Buscar Libro"
        << "\n\t5) Buscar libro en español\n\t6) Buscar libro de ciencia ficcion"
        ...
        switch(opcion){
            ...
            case 5: cout << "Buscando..." << endl;
                if(busquespanol())
                    cout << "hay almenos un libro en espanol" << endl;
                else
                    cout << "no hay libros en espanol :(" << endl;
                break;
            case 6: cout << "Buscando..." << endl;
                if(busqueficcion())
                    cout << "Hay almenos un libro de ciencia ficcion" << endl;
                else
                    cout << "no hay libros de ciencia ficcion :(" << endl;
                break;
            case 7: cout << "Buscando libro de mistery" << endl;
                if(elimisterio())
                    cout << "Libros de misterio borrado exitosamente :)" << endl;
                else
                    cout << "no  hay libros de misterio no se pudo borrar." << endl;
                break;
